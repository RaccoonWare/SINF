...
public class ModeloConsultaArticulos {
    ...
    private Thread hiloArchivo;//hilos para ejecuci�n paralela
    ...
    /**
     * A�ade componenetes al popup menu, generado automaticamene
     * @param component
     * @param popup
	...
	/**
	 * Cambia el boton de acci�n al estado "Eliminar", si se vuelve a oprimir se eliminara el dato del modelo, si se vuelve a llenar los datos regresa al estado modificable * @param vistaConsultas
     ...
     * cuando cambie la funci�n exportar a MVC tuve que obtener el modelo de la tabla en vez de usar ModeloT (por alguna raz�n  importarlo/asignarlo desde MVC hace que no funcione localmente, por lo que ahora se hace casteo desde el mvc
	 */
     ...
     * @see campoQuitable
     * @see QuitaCampos    
     * cuando cambie la funci�n exportar a MVC tuve que obtener el modelo de la tabla en vez de usar ModeloT (por alguna raz�n  importarlo desde MVC hace que no funcione localmente, por lo que ahora se hace casteo desde el mvc
     * se "modifico"  el codigo para restaurar la funci�n cuando el elemento esta filtrado (se habia perdido cuando se combino con el codigo de mario y se deshabilito la variable modeloT
	 */
	 ...
	 * pre-condici�n: boton acci�n en estado Eliminar, campos vacios
