...
public class ControladorInfraccion implements ActionListener, MouseListener{
	...
	public ControladorInfraccion(VistaInfraccion VistaBoleta, ModeloInfraccion ModeloBoleta) {
		...
		VistaInfraccion.txtMarcaSubmarca.addMouseListener(this);
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == VistaInfraccion.btnLimpiar){
			...
			VistaInfraccion.txtMarcaSubmarca.setText("");
			...
			if (VistaInfraccion.btnInsertar.getText().equals("Insertar")) {
				...
				try {
					...
					case "articulos":
						...
						break;
					case "marcaSubmarca":
						VistaInfraccion.txtMarcaSubmarca.setBackground(new Color(201,79,76));
						break;
					case "retencion":
	...
	public void mouseEntered(MouseEvent arg0) {
		...
		}else if (arg0.getSource() == VistaInfraccion.txtMarcaSubmarca) {
			VistaInfraccion.txtMarcaSubmarca.setBackground(new Color(234, 253, 255));
	...
	public void mouseExited(MouseEvent e) {
		...
		}else if (e.getSource() == VistaInfraccion.txtMarcaSubmarca) {
			VistaInfraccion.txtMarcaSubmarca.setBackground(new Color(187,202,204));
	...
	public void obtenerdatos() throws ErroresCaptura {
		...
		ModeloBoleta.setMarcaSubmarca(VistaInfraccion.txtMarcaSubmarca.getText().trim());
